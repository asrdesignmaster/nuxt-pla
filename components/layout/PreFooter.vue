            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="">
                    ...
                    <p class="text-gray-600 mt-2">Leafing is an art, done by an artist. Leafing is an art form which
                        gives royal
                        and aesthetic look to the decor. It is done traditionally for magnificent and regal
                        environments. Gold
                        silver leafing provides artistic and more defined interior space.</p>
                    <p class="text-gray-600 mt-2">We give our dedication to provide best manual skill with durability
                        and care of
                        minute details. Quality is not compromised over quantity. Our well skilled craftsman do their
                        work with

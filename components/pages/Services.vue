                        ...
                        <div class="flex items-center lg:items-start flex-col lg:flex-row">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">In a residential interior space leafing gives aesthetic looks
                                    and
                                    it is usually
                                    done to enhance the decoration of the space .Gold , Silver, Copper and Champagne
                                    leafing
                                    is done on
                        ...
                        <div class="flex items-center lg:items-start flex-col lg:flex-row">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">In a residential interior space leafing gives aesthetic looks
                                    and
                                    it is usually
                                    done to enhance the decoration of the space. Gold, Silver, Coper & champagne leafing
                                    is
                                    done on ceiling,
